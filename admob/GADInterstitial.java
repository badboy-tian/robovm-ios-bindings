...
public class GADInterstitial extends NSObject{
	...
	public GADInterstitial(String adUnitID) {
		super((SkipInit)null);
		initObject(initWithAdUnitID(adUnitID));
	}
	 ...
	 @Property
	   ...
	   // public native void setAdUnitID (String adUnitID);
	    ...
	    public native void setDelegate (GADInterstitialDelegate gadBannerViewDelegateAdapter);
