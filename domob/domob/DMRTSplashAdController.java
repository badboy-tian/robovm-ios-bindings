...
@NativeClass
public class DMRTSplashAdController extends DMSplashAdController{
	// For iPhone
...
//	              placementId:(NSString *)placementId   // Domob PlacementId
	...
	public DMRTSplashAdController(String publisherId, String placementId, UIWindow window) {
		//super((SkipInit)null);
		super(publisherId, placementId, window);
		initObject(initWithPublisherId(publisherId, placementId, window));
	}
	
	public DMRTSplashAdController(String publisherId, String placementId, UIWindow window, UIColor UIColor) {
		//super((SkipInit)null);
		super(publisherId, placementId, window, UIColor);
		initObject(initWithPublisherId(publisherId, placementId, window, UIColor));
	}

	public DMRTSplashAdController(String publisherId, String placementId, CGSize adSize, float offset, UIWindow window, UIColor UIColor, boolean animation) {
		//super((SkipInit)null);
		super(publisherId, placementId, adSize, offset, window, UIColor, animation);
