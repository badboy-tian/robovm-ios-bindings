...
@NativeClass
public class BmobFile extends NSObject{
	/**
	 *  上传文件
	 *
	 *  @param path          路径
	...
	public native static void uploadFileWithPath(String path, BmobFileResultBlock block, @Block BmobProgressBlock progressBlock);
	...
	public native static void uploadFileWithFilename(String filename, NSData  data, BmobFileResultBlock block, @Block BmobProgressBlock progressBlock);                      
	...
	@Method(selector = "uploadFilesWithPaths:resultBlock:progress:")
	public native static void uploadFilesWithPaths(List<String> array, BmobBatchFileUploadResultBlock block, @Block BmobProgressBlock progressBlock);   
	...
	public native static void uploadFilesWithDatas(List<NSDictionary> array, BmobBatchFileUploadResultBlock block,@Block BmobProgressBlock progressBlock); 
	...
	public native static void downloadFileWithFilename(String filename, BmobFileDownloadResultBlock block,@Block BmobProgressBlock progressBlock); 
	...
	public native static void localThumbnailImageWithFilepath(String filepath, int ruleID,@Block BmobLocalImageResultBlock block); 
