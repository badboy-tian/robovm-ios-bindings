...
public native static void setAppVersion(String appVersion);
...
@Method(selector = "setCrashReportEnabled:")
public native static void setCrashReportEnabled(boolean value);
...
public native static void setLogEnabled(boolean value);
...
public native static void setBackgroundTaskEnabled(boolean value);
...
@Method(selector = "setEncryptEnabled:")
public native static void setEncryptEnabled(boolean value);
///---------------------------------------------------------------------------------------
/// @name  开启统计
///---------------------------------------------------------------------------------------
...
@Method(selector = "startWithAppkey:")
public native static void startWithAppkey(String appKey);
...
@Method(selector = "startWithAppkey:reportPolicy:channelId:")
public native static void startWithAppkey(String appKey, ReportPolicy rp, String cid);
...
@Method(selector = "setLogSendInterval:")
public native static void setLogSendInterval(double second);
...
public native static void setLatency(int second);
...
@Method(selector = "logPageView:seconds:")
public native static void logPageView(int second);
...
@Method(selector = "beginLogPageView:")
public native static void beginLogPageView(String pageName);
...
@Method(selector = "endLogPageView:")
...
public native static void event(String eventId);

/** 自定义事件,数量统计.
使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID
*/
//+ (void)event:(NSString *)eventId label:(NSString *)label; // label为nil或@""时，等同于 event:eventId label:eventId;
@Method(selector = "event:label:")
public native static void event(String eventId, String label);

/** 自定义事件,数量统计.
使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID
*/
//+ (void)event:(NSString *)eventId attributes:(NSDictionary *)attributes;
@Method(selector = "event:attributes:")
public native static void event(String eventId, NSDictionary NSDictionary);

//+ (void)event:(NSString *)eventId attributes:(NSDictionary *)attributes counter:(int)number;
@Method(selector = "event:attributes:counter:")
public native static void event(String eventId, NSDictionary attributes, int number);
...
@Method(selector = "beginEvent:")
public native static void beginEvent(String eventId);

/** 自定义事件,时长统计.
使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID.
*/
//+ (void)endEvent:(NSString *)eventId;
@Method(selector = "endEvent:")
public native static void endEvent(String eventId);
...
@Method(selector = "beginEvent:label:")
public native static void beginEvent(String eventId, String label);
...
@Method(selector = "endEvent:label:")
public native static void endEvent(String eventId, String label);
...
@Method(selector = "beginEvent:primarykey:attributes:")
public native static void beginEvent(String eventId, String keyName, NSDictionary attributes);
...
@Method(selector = "endEvent:primarykey:")
public native static void endEvent2(String eventId, String keyName);
...
@Method(selector = "event:durations:")
public native static void event(String eventId, int millisecond);
...
@Method(selector = "event:label:durations:")
public native static void event(String eventId, String label, int millisecond);

/** 自定义事件,时长统计.
使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID.
*/
//+ (void)event:(NSString *)eventId attributes:(NSDictionary *)attributes durations:(int)millisecond;
@Method(selector = "event:attributes:durations:")
public native static void event2(String eventId, NSDictionary attributes, int millisecond);
...
*/
//+ (void)checkUpdate;
@Method(selector = "checkUpdate")
public native static void checkUpdate();
...
@Method(selector = "checkUpdate:cancelButtonTitle:otherButtonTitles:")
public native static void checkUpdate(String title, String cancelTitle, String otherTitle);
...
//@Method(selector = "checkUpdateWithDelegate:selector:")
//public native static void checkUpdateWithDelegate(Object delegate, SEL callBackSelectorWithDictionary);
...
@Method(selector = "updateOnlineConfig")
public native static void updateOnlineConfig();
...
//+ (NSString *)getAdURL;
@Method(selector = "getConfigParams:")
public native static String getConfigParams(String key);
@Method(selector = "getConfigParams")
public native static NSDictionary getConfigParams();
@Method(selector = "getAdURL")
public native static String getAdURL();
...
public native static void setLatitude(double latitude, double longitude);
...
public native static void setLatitude(CLLocation location);
...
*/
//+ (BOOL)isJailbroken;
@Method(selector = "isJailbroken")
public native static boolean isJailbroken();

/** 判断App是否被破解
*/
//+ (BOOL)isPirated;
@Method(selector = "isPirated")
public native static boolean isPirated();

//#pragma mark DEPRECATED

//+ (void)event:(NSString *)eventId acc:(NSInteger)accumulation;
@Method(selector = "event:acc:")
public native static void eventWithAccumulation(String eventId, int accumulation);

/** 自定义事件,数量统计.
使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID
*/
//+ (void)event:(NSString *)eventId label:(NSString *)label acc:(NSInteger)accumulation;
@Method(selector = "event:label:acc:")
public native static void eventWithAccumulation(String eventId, String label, int accumulation);
/** 自定义事件,数量统计.
使用前，请先到友盟App管理后台的设置->编辑自定义事件 中添加相应的事件ID，然后在工程中传入相应的事件ID
*/
...
public native static void startSession(NSNotification startSession);
